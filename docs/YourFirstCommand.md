...
Каждый из компонентов имеет уникальные свойства, которые должны быть указаны. Найти их список можно [по ссылке](https://discord.com/developers/docs/interactions/message-components).
```js
const component = {
  type: ComponentType,
